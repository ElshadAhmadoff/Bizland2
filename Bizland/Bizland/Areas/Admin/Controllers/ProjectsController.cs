...
namespace Bizland.Areas.Admin.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Image,CategoryId,Id")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Image,CategoryId,Id")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
